...
namespace CustomerVehicleManagement.Api.IntegrationTests.Helpers
{
    public class TestClaimsProvider
    {
        ...
        public static TestClaimsProvider WithShopAdminClaims()
        {
            ...
            provider.Claims.Add(new Claim(CustomClaimType.ShopRole.ToString(), ShopRole.Admin.ToString()));
        ...
        public static TestClaimsProvider WithShopOwnerClaims()
        {
            ...
            provider.Claims.Add(new Claim(CustomClaimType.ShopRole.ToString(), ShopRole.Owner.ToString()));
