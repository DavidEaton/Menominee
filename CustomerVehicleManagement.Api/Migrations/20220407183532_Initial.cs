    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryLabor", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryPart", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryTire", x => x.Id);
                });
...
<<<<<<<< HEAD:CustomerVehicleManagement.Api/Migrations/20220407183532_Initial.cs
                        ...
                        column: x => x.LaborId,
                        principalSchema: "dbo",
                        principalTable: "InventoryLabor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryItem_InventoryPart_PartId",
                        column: x => x.PartId,
                        principalSchema: "dbo",
                        principalTable: "InventoryPart",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryItem_InventoryTire_TireId",
                        column: x => x.TireId,
                        principalSchema: "dbo",
                        principalTable: "InventoryTire",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
========
