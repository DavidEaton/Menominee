...
namespace CustomerVehicleManagement.Api.Migrations
{
    ...
    [Migration("20220709180858_giftcertificates")]
    partial class giftcertificates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerVehicleManagement.Domain.Entities.Inventory.InventoryItemCourtesyCheck", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("InventoryItemCourtesyCheck", "dbo");
                });
            ...
            modelBuilder.Entity("CustomerVehicleManagement.Domain.Entities.Inventory.InventoryItemCourtesyCheck", b =>
                {
                    b.HasOne("CustomerVehicleManagement.Domain.Entities.Inventory.InventoryItem", null)
                        .WithOne("CourtesyCheck")
                        .HasForeignKey("CustomerVehicleManagement.Domain.Entities.Inventory.InventoryItemCourtesyCheck", "InventoryItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
