    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            if (HostEnvironment.IsProduction())
            {
                ...
                // Uncomment next line and comment previous line to NOT require authentication
                AddControllersWithOptions(services: services, isProduction: false);
        ...
        private static void AddControllersWithOptions(IServiceCollection services, bool isProduction, AuthorizationPolicy requireAuthenticatedUserPolicy = null)
        {
            ...
            .AddFluentValidation(options =>
            {
                ...
                // Even tho we specify only OrganizationToAddValidator, RegisterValidatorsFromAssemblyContaining
