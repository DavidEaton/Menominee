...
namespace CustomerVehicleManagement.Data.Migrations
{
    ...
    [Migration("20201116185255_Addresses")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerVehicleManagement.Core.Model.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CustomerVehicleManagement.Core.Model.OrganizationAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CustomerVehicleManagement.Core.Model.PersonAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CustomerVehicleManagement.Core.Model.Address", b =>
                {
                    b.HasOne("CustomerVehicleManagement.Core.Model.Organization", null)
                        .WithMany("Addresses")
                        .HasForeignKey("OrganizationId");

                    b.HasOne("CustomerVehicleManagement.Core.Model.Person", null)
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("CustomerVehicleManagement.Core.Model.OrganizationAddress", b =>
                {
                    b.HasOne("CustomerVehicleManagement.Core.Model.Address", "Address")
                        .WithMany()
