...
namespace MenomineePlayWASM.Shared.Migrations
{
    ...
    [Migration("20211119131500_VendorIdToVendorCode")]
    partial class VendorIdToVendorCode
    {
            ...
            modelBuilder.Entity("MenomineePlayWASM.Shared.Entities.Payables.Invoices.VendorInvoice", b =>
                {
                    ...
                    b.Property<DateTime?>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 11, 19, 8, 15, 0, 257, DateTimeKind.Local).AddTicks(1137));
