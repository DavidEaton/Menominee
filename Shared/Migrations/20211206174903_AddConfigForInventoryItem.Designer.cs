...
namespace MenomineePlayWASM.Shared.Migrations
{
    ...
    [Migration("20211206174903_AddConfigForInventoryItem")]
    partial class AddConfigForInventoryItem
    {
            ...
            modelBuilder.Entity("MenomineePlayWASM.Shared.Entities.Payables.Invoices.VendorInvoice", b =>
                {
                    ...
                    b.Property<DateTime?>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 6, 12, 49, 3, 567, DateTimeKind.Local).AddTicks(2186));
