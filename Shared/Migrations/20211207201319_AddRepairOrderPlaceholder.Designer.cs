...
namespace MenomineePlayWASM.Shared.Migrations
{
    ...
    [Migration("20211207201319_AddRepairOrderPlaceholder")]
    partial class AddRepairOrderPlaceholder
    {
            ...
            modelBuilder.Entity("MenomineePlayWASM.Shared.Entities.Payables.Invoices.VendorInvoice", b =>
                {
                    ...
                    b.Property<DateTime?>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 12, 7, 15, 13, 19, 196, DateTimeKind.Local).AddTicks(4906));
